...
<body>
    <div class="wrapper">
        ...
        <div class="content">
            <div class="user-info">
                <img src="{{asset('images/timg.jpg')}}" alt="" class="user-avator">
                <ul class="user-name">
                    <li class="name">{{$content->user->name}}</li>
                    <li class="time">{{$content->created_at}}</li>
                </ul>
            ...
            <div class="hot-comment">
                <img src="{{asset('images/hot.gif')}}" alt="">
