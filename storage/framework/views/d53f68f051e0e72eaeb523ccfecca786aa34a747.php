...
<body>
	<div align="center">
        <ul>
            <li style="background-color:#FF7F24"><a href="<?php echo e(asset('wxp/example/jsapi.php')); ?>">JSAPI支付</a></li>
            <li style="background-color:#698B22"><a href="<?php echo e(asset('wxp/example/micropay.php')); ?>">刷卡支付</a></li>
