		...
		<div id="signUp">
			...
			<div class="signUp">
				<form action="/sign" method="post" id="formLogin" onsubmit="return formcheck()">
					...
					<input type="text" name="name" id="name" placeholder="用户名" value="<?php echo e(old('name')); ?>">
					<p class="checkname"></p>
					<input type="text" name="mail" id="mail" placeholder="输入邮箱" value="<?php echo e(old('mail')); ?>">
					<p class="checkmail"></p>
					<input type="password" name="password" id="password" placeholder="密码" value="<?php echo e(old('password')); ?>">
					<p class="checkpassword"></p>
					<input type="password" name="password_confirmation" id="password_confirmation" placeholder="验证密码" value="<?php echo e(old('password_confirmation')); ?>">
